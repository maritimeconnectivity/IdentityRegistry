...
INSERT INTO `organizations` (name, mrn, email, address, country, url, approved, created_at, updated_at) VALUES 
    ('Maritime Cloud', 'urn:mrn:mcl:org:maritimecloud', 'info@maritimecloud.net', '1 Martime Street, The Eight Ocean', 'Denmark', 'http://maritimecloud.net', 1, NOW(), NOW());
